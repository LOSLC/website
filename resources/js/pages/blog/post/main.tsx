...
import MetaData from '@/components/blog/post/meta-data';
                            ...
                            <div className="mt-4 border-t">
                                <h3 className="my-4 text-lg font-bold">
                                    ...
                                    {props.post.commentsCount > 1
                                        ? languageProvider.get('blog.post.comments_plural')
                                        : languageProvider.get('blog.post.comments')}
                                </h3>
...
function LikeBtn({ props }: { props: Props }) {
    ...
    const handleLikeSubmit: FormEventHandler = (e) => {
        e.preventDefault();
        submit(route('blog.like', { post: props.post.id }), {
            preserveScroll: true,
        });
    };
