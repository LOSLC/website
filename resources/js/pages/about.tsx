...
export default function Home() {
  return (
    <Layout>
      <div className="relative flex-col w-full h-screen scroll-smooth">
        <img
        ...
        />
        <div className="flex w-full min-h-[60vh] md:h-screen justify-center z-20 md:items-center bg-background/50 backdrop-blur-2xl">
        ...
        {/* Next section */}
        <div className="flex flex-col items-center md:flex-row w-full h-auto md:h-screen gap-6 md:gap-10 justify-around px-4 md:px-20 py-8 md:py-4">
        ...
        <div className="min-h-screen">
          ...
          <div
            id="contact"
            className="flex flex-col w-full mt-6 md:mt-10 items-center"
          >
        ...
        <div className="flex flex-col w-full mt-6 md:mt-10 items-center py-4 md:py-6">
        ...
        {/* Footer */}
        <div className="flex flex-col w-full py-4 bg-background/50">
